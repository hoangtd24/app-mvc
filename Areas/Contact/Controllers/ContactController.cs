...
namespace aspnetcoremvc.Areas.Contact.Controllers
{
    [Area("Contact")]
    public class ContactController : Controller
    {
        ...
        public ContactController(AppMvcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Phone,Content,DateSend")] ContactModel contactModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Phone,Content,DateSend")] ContactModel contactModel)
        {
